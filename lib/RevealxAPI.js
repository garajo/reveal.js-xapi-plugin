...
// const ui_c = UIConsole(document.getElementsByClassName("reveal")[0])
...
export default async (reveal, {
  ...
  console.log('shelled_component', shelled_component)
  console.log('UIConsole', UIConsole.log('hello'))
  console.log('UIConsole', UIConsole.pushHistory('hello'))
  console.log('UIConsole', UIConsole.renderComponent('hello'))
