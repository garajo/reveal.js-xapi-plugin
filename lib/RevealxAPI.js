...
import Console, {trace, update as updateConsole} from './Console'
...
export default async (reveal, {
  ...
  console.log('-------')
  console.log(Console(document.getElementsByClassName("reveal")[0], {biz: 'bam'}))
  console.log(updateConsole({whim: 'wham'}))
