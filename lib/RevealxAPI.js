...
// UIConsole.init(document.getElementsByClassName("reveal")[0])
...
export default async (reveal, {
  ...
  console.log('ui_c', ui_c.log('hello'))
  console.log('ui_c', ui_c.pushHistory('bye'))
  console.log('ui_c', ui_c.renderComponent())
