...
export default async (reveal, {
  ...
  if (dev_mode) {
    ...
    currentDiv[0].appendChild(statement_helper_shell)
    const statementHelper = render(<StatementHelper data={profile_data} />, statement_helper_shell)
