...
class StatementHelper extends Component {
  ...
  render() {
    ...
    return (<div style={{zIndex: 3}} class="statement_component">
      ...
      <div>
        <input id="verbs_chk" onClick={this.filterIn} type="checkbox" value="filterverb" checked={filterverb} />
        <label for="verbs_chk">verb</label>
        <input id="activity_chk" onClick={this.filterIn} type="checkbox" value="filteractivity" checked={filteractivity} />
        <label for="activity_chk">activity</label>
        <input id="others_chk" onClick={this.filterIn} type="checkbox" value="filterother" checked={filterother} />
